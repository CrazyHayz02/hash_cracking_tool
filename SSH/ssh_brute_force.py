import paramiko #Imported paramiko for SSH
import datetime #Imported dateTime for the time
import os #Imported os used for commands in command prompt


wordsleft = 27414 #Amout of words in word list plus 1
dic = open("ow_tiny_lower.lst", "r") #Collecting the wordlist
...
for keyword in dic: #Goes throught the words in the wordlist
